...
class Client1(object):
    ...
    REQUEST_HEADERS = {
        ...
        "x-li-lang": "en_US",
        "x-li-track": '{"clientVersion":"1.5.*","osName":"web","timezoneOffset":5,"deviceFormFactor":"DESKTOP","mpName":"voyager-web"}',
    ...
    def __init__(self, debug=False, refresh_cookies=False):
        ...
        self.session.headers = Client1.REQUEST_HEADERS
    ...
    def _request_session_cookies(self):
        ...
        res = requests.get(
            f"{Client1.AUTH_BASE_URL}/uas/authenticate",
            headers=Client1.AUTH_REQUEST_HEADERS,
        )
